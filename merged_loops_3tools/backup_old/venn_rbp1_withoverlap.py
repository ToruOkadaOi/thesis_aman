...
mustache_file = "mustache_merged_loops_rbp1.bedpe"
...
extract_original_bedpe(df_peakachu, only_p, "unique_peakachu_rbp1.bedpe")
extract_original_bedpe(df_mustache, only_m, "unique_mustache_rbp1.bedpe")
extract_original_bedpe(df_cooldots, only_c, "unique_cooldots_rbp1.bedpe")
...
plt.savefig("mergedloops_eed_mut.png", dpi=300, bbox_inches='tight')
plt.show()