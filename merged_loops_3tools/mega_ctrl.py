...
mustache_file = "mustache_merged_loops_ctrl_fixed_clean.bedpe"
cooldots_file = "cooldots_merged_loops_ctrl.bedpe"
# peakachu_merged_loops_ctrl.bedpe mustache_merged_loops_ctrl.bedpe cooldots_merged_loops_ctrl.bedpe
# ------------------------------
...
extract_original_bedpe(df_peakachu, only_p, "unique_peakachu_ctrl_fixed.bedpe")
extract_original_bedpe(df_mustache, only_m, "unique_mustache_ctrl_fixed.bedpe")
extract_original_bedpe(df_cooldots, only_c, "unique_cooldots_ctrl_fixed.bedpe")
...
plt.savefig("mergedloops_ctrl_fixed.png", dpi=300, bbox_inches='tight')
plt.show()
...
extract_original_bedpe(all_loops_df, mega_ids, "mega_merged_loops_ctrl.bedpe")